...
public class PanelIndices extends JPanel implements VistaIndices {
    ...
    public PanelIndices() {
        jbCrear = new JButton("Crear índice");
        ...
        jcbOpcion.setBorder(BorderFactory.createTitledBorder("Tipo de Índice"));
        ...
        jspSalida.setBorder(BorderFactory.createTitledBorder("Salida del índice"));
